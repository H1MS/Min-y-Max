...
from mapa import imprimir_tablero, salida
from movimientos import mover_humano, movimientos
from iagameplay import mejor_mov_gato, mejor_mov_raton, gato, raton
